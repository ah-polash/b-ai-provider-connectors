<?php
/**
 * Model metadata directory for custom provider slot 1.
 *
...
/**
 * Directory class for custom slot 1.
 *
 * @since 1.0.0
 */
class CustomModelMetadataDirectory1 extends BaseModelMetadataDirectory {
