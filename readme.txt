...
B All-in-One AI Providers extends the WordPress AI Client and the core Connectors screen (Settings &rarr; Connectors) with four features:
...
The full source code is developed in the open on GitHub: https://github.com/ah-polash/b-all-in-one-ai-providers
...
1. Upload the `b-all-in-one-ai-providers` folder to the `/wp-content/plugins/` directory, or install it from the Plugins screen.
