#!/usr/bin/env python3
"""
Generates the wordpress.org artwork for AI Provider Connectors.
...
def icon_svg(slug, comment, style, body):
  ...
  <!--
    AI Provider Connectors — plugin icon, variant "{slug}".
    {comment}
...
# --------------------------------------------------------------------------
BANNERS = [
    ('aiswitch', 'AI PROVIDER CONNECTORS', 'Connect any AI', 'to WordPress.', 'Enable, test and prioritise 11 providers from one settings screen'),
]
...
def banner_svg(slug, pill, hero1, hero2, sub, body):
  ...
  <!--
    AI Provider Connectors — wordpress.org banner (1544x500), variant "{slug}".
